...
class KodiApiTest extends TestCase implements ApiTestInterface
{
  ...
  {
    $this->apiTestBase->it_should_updated_item_user_updated_at('kodi/episode_seen.json');
  }

  #[Test]
  public function it_should_add_a_item_user_to_existing_item()
  {
    $this->apiTestBase->it_should_add_a_item_user_to_existing_item('kodi/episode_seen.json');
  }
